...
$route['api/user/register'] = 'front/api/register';



$route['api/user/login'] = 'front/api/login';
...
$route['login'] = 'front/users/loginview';
$route['signup'] = 'front/users/signupview';
...
$route['user/comission'] = 'front/users/comission';
...
$route['category/(:any)'] = 'front/products';
$route['category/(:any)/sub/(:any)'] = 'front/products';
...
$route['wedding-delight'] = 'front/products';

$route['wedding-delight/search-data'] = 'front/products/ajaxPaginationSearch';

$route['wedding-delight/search-data/(:num)'] = 'front/products/ajaxPaginationSearch/$1';
...
$route['place-order'] = 'front/order/placeOrder';

$route['order-information'] = 'front/order/ccavResponceHandler';

$route['payment'] = 'front/order/ccavRequestHandler';

$route['thankyou'] = 'front/order/orderSuccess';
...
$route['admin/twofactor-login'] = 'admin/twofactor/twofactorLogin';



$route['admin/two-factor'] = 'admin/twofactor';

$route['admin/twofactor-save-data'] = 'admin/twofactor/saveData';
...
$route['admin/get-subcategory'] = 'admin/categories/getSub';
...
$route['admin/add-subcategory'] = 'admin/subcategories/manageCategory';

$route['admin/edit-subcategory/(:any)'] = 'admin/subcategories/manageCategory/$1';
...
$route['admin/change-featured-subcategory'] = 'admin/subcategories/changeFeaturedCategory';

$route['admin/delete-subcategory'] = 'admin/subcategories/deleteData';

$route['admin/category-alias'] = 'admin/subcategories/AliasManage';

$route['admin/save-subcategory-ordering'] = 'admin/subcategories/saveOrdering';
...
$route['order/manage'] = 'admin/orders/orderManage';

$route['order/saveStatus'] = 'admin/orders/updateStatus';
