	...
	<div class="card-header py-3 forms">
		<div class="row form-row mb-2">
			<div class="col-sm-6 d-flex">
				<h6 class="title my-auto">How It Works list</h6>
			</div>
			<div class="col-sm-6 text-right">
				<?php if(getUserDetails($this->session->userdata('user_id'),'access_management') && in_array('add-how-it-works', getUserDetails($this->session->userdata('user_id'),'access_management'))){?>
				<a href="<?php echo base_url()?>admin/add-how-it-works" class="btn btn-sm btn-success" data-tooltip="Add"><i class="fa fa-plus"></i></a>
				<?php } ?>
				...
				<a href="javascript:void(0)" class="btn btn-sm btn-danger" onclick="deleteHowItWork('all',0)" data-tooltip="Delete"><i class="fa fa-trash"></i></a>
				<?php } ?>
				<a href="javascript:void(0)" onclick="saveSorting()" class="btn btn-sm btn-warning" data-tooltip="Sorting save"><i class="fa fa-sort"> Save Ordering</i></a>
