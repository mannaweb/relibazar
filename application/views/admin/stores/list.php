	...
	<div class="card-header py-3 forms">
		<div class="row form-row mb-2">
			<div class="col-sm-6 d-flex">
				<h6 class="title my-auto">Store list</h6>
			</div>
			<div class="col-sm-6 text-right">
				<?php if(getUserDetails($this->session->userdata('user_id'),'access_management') && in_array('add-store', getUserDetails($this->session->userdata('user_id'),'access_management'))){?>
				<a href="<?php echo base_url()?>admin/add-store" class="btn btn-sm btn-success" data-tooltip="Add"><i class="fa fa-plus"></i></a>
				<?php } ?>
				...
				<a href="javascript:void(0)" class="btn btn-sm btn-danger" onclick="deleteStore('all')" data-tooltip="Delete"><i class="fa fa-trash"></i></a>
				<?php } ?>
