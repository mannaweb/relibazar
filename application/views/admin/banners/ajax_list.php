...
<?php if($banners){ foreach($banners as $key=>$val){?>
	<tr>
		...
		<?php if(getUserDetails($this->session->userdata('user_id'),'access_management') && in_array('edit-banner', getUserDetails($this->session->userdata('user_id'),'access_management'))){?>
		...
		<td>
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					...
					<?php } ?>
					<?php if(getUserDetails($this->session->userdata('user_id'),'access_management') && in_array('change-status-banner', getUserDetails($this->session->userdata('user_id'),'access_management'))){?>
					...
					<?php if(getUserDetails($this->session->userdata('user_id'),'access_management') && in_array('delete-banner', getUserDetails($this->session->userdata('user_id'),'access_management'))){?>
