<?php if($testimonials){ foreach($testimonials as $key=>$val){?>
	...
	<tr>
		...
		<?php if(getUserDetails($this->session->userdata('user_id'),'access_management') && in_array('edit-testimonial', getUserDetails($this->session->userdata('user_id'),'access_management'))){?>
		...
		<td>
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					...
					<?php if(getUserDetails($this->session->userdata('user_id'),'access_management') && in_array('change-status-testimonial', getUserDetails($this->session->userdata('user_id'),'access_management'))){?>
					...
					<?php if(getUserDetails($this->session->userdata('user_id'),'access_management') && in_array('delete-testimonial', getUserDetails($this->session->userdata('user_id'),'access_management'))){?>
