	...
	<div class="card-header py-3 forms">
		<div class="row form-row mb-2">
			...
			<div class="col-sm-6 text-right">
				<?php if(getUserDetails($this->session->userdata('user_id'),'access_management') && in_array('add-testimonial', getUserDetails($this->session->userdata('user_id'),'access_management'))){?>
