	...
	<div class="card-header py-3 forms">
		<div class="row form-row mb-2">
			...
			<div class="col-sm-6 text-right">
				<?php if(getUserDetails($this->session->userdata('user_id'),'access_management') && in_array('add-category', getUserDetails($this->session->userdata('user_id'),'access_management'))){?>
				...
				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
					<thead>
						<tr>
							...
							<th>
								<a href="javascript:void(0)" class="sorting ordering" onclick="sortBy('ordering','categories.ordering','ASC')">
							...
							<th>
								<a href="javascript:void(0)" class="sorting name" onclick="sortBy('name','categories.name','ASC')">
							...
							<th>
								<a href="javascript:void(0)" class="sorting created_at" onclick="sortBy('created_at','categories.created_at','ASC')">
